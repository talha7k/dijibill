      ...
      {#if $currentView === 'products'}
        <div class="relative">
          <input
            ...
            class="w-64 px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
